...
class mpu6050:
    ...
    def get_gyro_data(self):
        raw_gyro = self.get_raw_gyro_data()
        
        x = raw_gyro['x'] - self.gyroXcal 
        y = raw_gyro['y'] - self.gyroYcal
        z = raw_gyro['z'] - self.gyroZcal
    ...
    def calibrateGyro(self, N):
        ...
        for ii in range(N):
            ...
            self.gyroXcal += gyro['x']
            self.gyroYcal += gyro['y']
            self.gyroZcal += gyro['z']
        ...
        #file.write("X axis offset: " + str(round(self.gyroXcal,1))+"\tY axis offset: " + str(round(self.gyroYcal,1))+"\tZ axis offset: " + str(round(self.gyroZcal,1)) + "\n")
        time.sleep(2)
